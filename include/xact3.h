...
#define IXACT3Engine_Stop(p,a,b)                   (p)->lpVtbl->Stop(p,a,b)
#define IXACT3Engine_SetVolume(p,a,b)              (p)->lpVtbl->SetVolume(p,a,b)
#define IXACT3Engine_Pause(p,a,b)                  (p)->lpVtbl->Pause(p,a,b)
...
#define IXACT3Engine_SetVolume(p,a,b)              (p)->SetVolume(a,b)
